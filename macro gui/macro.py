...
def baixarVF(nome_VF):
    ...
    esperarPor("office.png", timeout= 30, iniX=0, iniY=0, fimX=0.6, fimY=0.5)
    moveAndClick("office.png", "left")
    esperarPor("excel.png", timeout= 30, iniX=0, iniY=0, fimX=0.6, fimY=0.5)
    ...
    if doors == "EMEA":
        ...
        timeout = esperarPor("excel_icone_latam.png", timeout=1200, iniX=0, iniY=0.5, fimX=1, fimY=0.98, imagem_interrupcao="fechar_erro.png", interrupcao_iniX=0, interrupcao_iniY=0.3, interrupcao_fimX=0.5, interrupcao_fimY=0.98)
        if not timeout:
            mensagem = f"Falha ao exportar VF {nome_VF}: Excel não encontrado ou erro ocorreu"
            registrar_log(mensagem, "ERRO")
            moveAndClick("fechar_erro.png", "left")
            ...
            time.sleep(2)
            moveAndClick("excel_icone_latam.png", "right")
            esperarPor("close_excel_latam.png", timeout=10, iniX=0.05, iniY=0.05, fimX=0.95, fimY=0.95)
            moveAndClick("close_excel_latam.png", "left")
            esperarPor("save_excel_latam.png", timeout=10, iniX=0.05, iniY=0.05, fimX=0.95, fimY=0.95)
            moveAndClick("save_excel_latam.png", "left")
            esperarPor("save_excel2_latam.png", timeout=10, iniX=0.05, iniY=0.05, fimX=0.95, fimY=0.95)
            pyautogui.write(nome_arquivo)
            time.sleep(1)
            moveAndClick("save_excel2_latam.png", "left")
            time.sleep(5)
            moveAndClick("close_VF.png", "left")
            esperarPor("continuar_close_vf.png", timeout=10, iniX=0.05, iniY=0.05, fimX=0.8, fimY=0.95)
            moveAndClick("continuar_close_vf.png", "left")
...
def encontrar_posicao_x(image, iniX=0, iniY=0, fimX=1, fimY=1):
    """
    Procura por uma imagem na tela e retorna sua coordenada x mais à esquerda
    como percentual da largura da tela.
    ...
    Returns:
        float: Coordenada x mais à esquerda da imagem como percentual da tela
...
def procura_projeto(nome):
    ...
    if esperarPor("pasta.png",timeout=120, iniX=0.3, iniY=0.4, fimX=0.7, fimY=0.8):
...
def main_macro(projetos, dominios, use_cases, VFs, doors):
    ...
    for projeto in projetos:
        ...
        if esperarPor("pasta.png"):
            pos_x = encontrar_posicao_x("tipo_menu.png", iniX=0.1, iniY=0.05, fimX=0.8, fimY=0.4)
            pastas_niveis = mapear_pastas(icone_path="images/pasta.png", iniX=0.1, iniY=0.1, fimX=pos_x, fimY=0.95)
        ...
        if esperarPor("pasta_amarela.png", timeout= 30):
            pos_x = encontrar_posicao_x("tipo_menu.png", iniX=0.1, iniY=0.05, fimX=0.8, fimY=0.4)
            pastas_requerimentos = mapear_pastas(icone_path="images/pasta_amarela.png", iniX=0.1, iniY=0.1, fimX=pos_x, fimY=0.95)
        ...
        if esperarPor("pasta_amarela.png"):
            pos_x = encontrar_posicao_x("tipo_menu.png", iniX=0.1, iniY=0.05, fimX=0.8, fimY=0.4)
            pastas_dominios = mapear_pastas(icone_path="images/pasta_amarela.png", iniX=0.1, iniY=0.1, fimX=pos_x, fimY=0.95)
            ...
            if dominio_encontrado:
                ...
                if esperarPor("pasta_amarela.png"):
                    pos_x = encontrar_posicao_x("tipo_menu.png", iniX=0.1, iniY=0.05, fimX=0.8, fimY=0.4)
                    pastas_use_cases = mapear_pastas(icone_path="images/pasta_amarela.png", iniX=0.1, iniY=0.1, fimX=pos_x, fimY=0.95)
                    ...
                    for use_case in pastas_para_processar:
                        ...
                        pos_x = encontrar_posicao_x("tipo_menu.png", iniX=0.1, iniY=0.05, fimX=0.8, fimY=0.4)
                        sub_pastas = mapear_pastas(icone_path="images/pasta_amarela.png", iniX=0.1, iniY=0.1, fimX=pos_x, fimY=0.95)
                        vf_nomes = mapear_pastas(icone_path="images/icone_vf.png", iniX=0.1, iniY=0.13, fimX=pos_x, fimY=0.95)
                        ...
                        if sub_pastas != {}:
                            for sub_pasta in sub_pastas:
                                ...
                                pos_x = encontrar_posicao_x("tipo_menu.png", iniX=0.1, iniY=0.05, fimX=0.8, fimY=0.4)
                                vf_nomes = mapear_pastas(icone_path="images/icone_vf.png", iniX=0.1, iniY=0.1, fimX=pos_x, fimY=0.95)
...
if __name__ == "__main__":
    # Default values when running directly
    projetos = ["226MCA","291","521MCA","521MY21","598","363","341","281","3580","2651"]
    dominios = ["Climate", "Comfort Climate"]
    use_cases = []
    VFs = ["VF126"]
    doors = "LATAM"
    
    main_macro(projetos, dominios, use_cases, VFs, doors)
