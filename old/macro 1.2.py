...
def baixarVF(nome_VF):
    ...
    esperarPor("main.png", timeout=10, iniX=0.7, iniY=0.05, fimX=1, fimY=0.5)
    moveAndClick("main.png", "right")
    esperarPor("propriedades.png", timeout=10, iniX=0.7, iniY=0.05, fimX=1, fimY=0.5)
...
projetos = ["139EL","250MY24","250MY26","312MCA","332BEV","334MCA","356MCA","356MHEV","520MY24","637BEV","637MCA","846","965","ALFAMCA","ARM20","ARM23","LP3","M240","M240MY26-BEV","MASAHMCA","MASAHMY26","332TR"]
    ...
    if esperarPor("pasta_amarela.png"):
        ...
        for nome_pasta in pastas_dominios:
            ...
            for dominio in dominios:
                if dominio.replace(" ", "").lower() == nome_normalizado:
